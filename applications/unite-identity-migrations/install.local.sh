...
tput setaf 6; echo "# Installing UNITE Identity Migrations service (LOCAL)"; tput sgr0
echo ""
...
git clone https://$ghb_tkn@github.com/dkfz-unite/unite-identity-migrations.git src
echo ""
