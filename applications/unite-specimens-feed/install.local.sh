...
tput setaf 6; echo "# Installing UNITE Specimens Datafeed service (LOCAL)"; tput sgr0
echo ""
...
git clone https://$ghb_tkn@github.com/dkfz-unite/unite-specimens-feed.git src
echo ""
