...
tput setaf 6; echo "# Installing UNITE analysis service (Differential Proterin Expression)"; tput sgr0
echo ""
...
git clone --single-branch --depth 1 --branch "$branch" https://$ghb_tkn@github.com/dkfz-unite/unite-analysis-dep.git src
echo ""
