...
tput setaf 6; echo "# Installing UNITE analysis service (Proterin Expression Distribution)"; tput sgr0
echo ""
...
git clone --single-branch --depth 1 --branch "$branch" https://$ghb_tkn@github.com/dkfz-unite/unite-analysis-cedp.git src
echo ""
