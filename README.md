...
- _github_ - **user** name and personal access **token** with full repository and packages permissions for accessing source code from **Github** repositories (follow github [instructions](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token) to generate it)
