...
tput setaf 6; echo "# Installing UNITE Migrations service (LOCAL)"; tput sgr0
echo ""
...
GITHUB_USER=$ghb_usr GITHUB_TOKEN=$ghb_tkn MYSQL_USER=$sql_usr MYSQL_PASSWORD=$sql_pwd docker-compose -p '' -f docker-compose.local.yml up -d --build
