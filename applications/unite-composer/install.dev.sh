...
tput setaf 6; echo "# Installing UNITE Composer service (DEV)"; tput sgr0
echo ""
...
git clone https://github.com/dkfz-unite/unite-composer.git src
echo ""

tput setaf 4; echo "# Building and running docker image"; tput sgr0
GITHUB_USER=$ghb_usr GITHUB_TOKEN=$ghb_tkn ELASTIC_USER=$els_usr ELASTIC_PASSWORD=$els_pwd MYSQL_USER=$sql_usr MYSQL_PASSWORD=$sql_pwd docker-compose -p '' -f docker-compose.dev.yml up -d --build