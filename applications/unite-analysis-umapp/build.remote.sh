...
tput setaf 6; echo "# Installing UNITE analysis service (UMAP of Proterin Expressions)"; tput sgr0
echo ""
...
git clone --single-branch --depth 1 --branch "$branch" https://$ghb_tkn@github.com/dkfz-unite/unite-analysis-umapp.git src
echo ""
